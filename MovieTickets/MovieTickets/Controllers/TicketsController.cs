...
namespace MovieTickets.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TicketId,movie,movieImage,description,ticketPrice,dateTime")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,movie,movieImage,description,ticketPrice,dateTime")] Ticket ticket)
        {
